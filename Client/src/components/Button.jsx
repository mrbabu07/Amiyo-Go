...
const Button = forwardRef(
  (
    ...
    const variants = {
      ...
      link: "text-primary-700 hover:text-primary-800 underline-offset-4 hover:underline focus:ring-primary-500 dark:text-primary-300 dark:hover:text-primary-200",
    };
...
export const FAB = forwardRef(({ icon, className = "", ...props }, ref) => {
  return (
    <motion.button
      ref={ref}
      className={`fixed bottom-6 right-6 w-14 h-14 bg-primary-600 text-white rounded-full shadow-lg hover:bg-primary-700 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:bg-primary-500 dark:hover:bg-primary-400 dark:focus:ring-offset-gray-950 z-50 flex items-center justify-center ${className}`}
